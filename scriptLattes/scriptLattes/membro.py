...
class Membro:
	...
	enderecoProfissionalCep = ''
	enderecoProfissionalCidade = ''
	enderecoProfissionalUf = ''
	enderecoProfissionalPais = ''
	...
	def obterCoordenadasDeGeolocalizacao(self):
		...
		self.enderecoProfissionalCidade = geo.cidade
		self.enderecoProfissionalUf = geo.uf
		self.enderecoProfissionalCep = geo.cep
		self.enderecoProfissionalPais = geo.pais
